    ...
    if(_ObjectHandle != noone){
        if(_ObjectHandle.Corner == false){
            ...
            if(_ObjectHandle.image_angle == 90 && scrPlayerCollisionRightSensor(_ObjectHandle) && Speed >= 0){
            ...
            if(_ObjectHandle.image_angle == 180 && Gravity < 0 && (scrPlayerCollisionCSensor(_ObjectHandle, 2) || scrPlayerCollisionDSensor(_ObjectHandle, 2))){
                Ground    = false;
                AngleMode = 0;
                Angle     = 0;
                Gravity   = _ObjectHandle.Power;
            ...
            if(_ObjectHandle.image_angle == 270 && scrPlayerCollisionLeftSensor(_ObjectHandle) && Speed <= 0){     
                Speed     = _ObjectHandle.Power;
                image_xscale = 1;
                _ObjectHandle.image_speed = 0.2;
                if(global.Haptic == true && objGlobal.OS == "Android"){
